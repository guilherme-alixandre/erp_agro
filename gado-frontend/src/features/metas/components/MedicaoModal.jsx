...
function MedicaoModal({ meta, lotes, emailUsuario, medicaoParaEditar, onClose, onSaved }) {
  ...
  const loteSelecionado = form.loteId ? lotes.find((l) => String(l.id) === form.loteId) ?? null : null
  ...
  return (
    <div className="modal-overlay" role="dialog" aria-modal="true">
      <div className="modal-card">
        ...
        <p className="meta-form__subtitle">
        ...
        <form className="meta-form" onSubmit={handleSubmit} noValidate>
          <div className="form-group">
            <label>
              ...
              {erros.loteId ? <span className="field-error-msg">{erros.loteId}</span> : null}
            </label>
          </div>
          ...
          <div className="form-group">
            <label>
              ...
              />
              {erros.quantidadeLancada ? <span className="field-error-msg">{erros.quantidadeLancada}</span> : null}
            </label>
          </div>
